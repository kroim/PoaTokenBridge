      ...
      <ModalOverlay background="modalBG">
        ...
        >
          ...
          >
            ...
            <Text>Welcome to the SwissDLTBridge UI</Text>
          </ModalHeader>
          <ModalBody px={8} py={0}>
            <Flex align="center" direction="column" fontSize="sm">
              <Text as="p" textAlign="center" mb="4">
                We’re launching our SwissDLTBridge and our UI App on a beta-testing
              ...
              <Text as="p" textAlign="center" mb="4">
                {
                  'Use of this app and the SwissDLTBridge is at your own risk. Users may experience unexpected delays, unexpected visual artifacts, unexpected loss of tokens or funds from improper app configuration, or other negative outcomes. '
                }
              </Text>
              <Text as="p" textAlign="center" mb="4">
                {
